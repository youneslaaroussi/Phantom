...
<svg viewBox="0 0 800 340" xmlns="http://www.w3.org/2000/svg" style="width:100%;max-width:800px;margin:24px auto;display:block;font-family:'Google Sans',system-ui,sans-serif">
  ...
  <circle cx="62" cy="82" r="12" fill="#e8f0fe"/><path d="M58,78 v4 a4,4 0 0,0 8,0 v-4 M58,84 a6,6 0 0,0 8,0 M62,87 v2" fill="none" stroke="#4285F4" stroke-width="1.5" stroke-linecap="round"/>
  ...
  <circle cx="62" cy="138" r="12" fill="#e6f4ea"/><path d="M53,138 Q62,131 71,138 Q62,145 53,138Z" fill="none" stroke="#34A853" stroke-width="1.5"/><circle cx="62" cy="138" r="2.5" fill="#34A853"/>
  ...
  <circle cx="62" cy="194" r="12" fill="#fef7e0"/><path d="M57,189 l10,10 M67,189 l-10,10" fill="none" stroke="#e37400" stroke-width="1.5" stroke-linecap="round"/>
  ...
  <circle cx="62" cy="250" r="12" fill="#fce8e6"/><path d="M62,243 l7,3 v5 c0,4 -3,7 -7,9 -4,-2 -7,-5 -7,-9 v-5 z" fill="none" stroke="#EA4335" stroke-width="1.3" stroke-linejoin="round"/><path d="M59,250 l2,2 4,-4" fill="none" stroke="#EA4335" stroke-width="1.3" stroke-linecap="round" stroke-linejoin="round"/>
